    ...
    <main className="min-h-screen bg-linear-to-br from-purple-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
      <section className="w-full max-w-md bg-white dark:bg-gray-900 dark:text-gray-100 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
        <div className="px-6 pt-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Entrar</h1>
          <p className="text-sm text-gray-600 mt-1">Acesse sua conta do MoneyMagnet.</p>
        </div>
        ...
        <form className="px-6 pb-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <a href="/forgot-password" className="text-sm text-purple-600 hover:underline">Esqueci minha senha</a>
          </div>

          <button
            type="submit"
            className="w-full bg-purple-600 text-white font-medium py-3 rounded-lg hover:bg-purple-700 hover:cursor-pointer hover:scale-105 transition duration-200"
            disabled={loading}
          >
          ...
          <p className="text-sm text-center text-gray-600">
            Ainda não tem conta? <a href="/register" className="text-purple-600 hover:underline">Criar conta</a>
          </p>
        </form>
      </section>
      {error && (
